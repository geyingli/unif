...
class RecBERT3(BaseDecoder, BERTEncoder):
    def __init__(self,
                 bert_config,
                 is_training,
                 input_ids,
...
def sample_wrong_tokens(
    ...
    #      rep_label_ids: 591 9521 -> 591 9521
    ...
    for _ in range(max_del):
        ...
        if _id == _input_ids[index + 1]:
            _rep_label_ids[index + 1], _rep_label_ids[index] = _rep_label_ids[index], _rep_label_ids[index + 1]
