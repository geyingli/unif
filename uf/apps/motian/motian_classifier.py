...
from .motian import MotianEncoder, BERTConfig, get_decay_power
...
class MotianClassifier(ClassifierModule):
    """ Single-label classifier on Motian. """
