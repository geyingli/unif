...
#        tf.logging.info('***************************************')
#        tf.logging.info('teacher_weight: %s' % _teacher_weight[:M])
#        tf.logging.info('student_weight: %s' % _student_weight[M:])
