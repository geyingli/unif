...
class SPELM(BERTLM, LMModule):
    ...
    def _convert_X(self, X_target, is_training, tokenized):
        ...
        for ex_id, example in enumerate(X_target):
            ...
            assert len(example) == 2, "`%s` only supports two-sentence inputs." % self.__class__.__name__
    ...
    def _set_placeholders(self, target, on_export=False, **kwargs):
        self.placeholders = {
            ...
            "position_ids": common.get_placeholder(target, "position_ids", [None, self.max_seq_length], tf.int32),
