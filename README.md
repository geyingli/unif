...
框架目前主要为我个人及团队所用，靠兴趣推动至今。如果能受到更多人，包括您的认可，我们会愿意投入更多精力进行丰富与完善。如果您喜欢，请点个 star 作为支持，不胜感激。如果有希望实现的 SOTA 算法，留下 issue，我们会酌情考虑，并抽工作之余的时间为您编写。通常三日以内可实现。任何需求和建议都不尽欢迎。最后，感谢你读到这里。