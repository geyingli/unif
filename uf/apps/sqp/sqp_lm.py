...
from .sqp import SQPLMEncoder, create_masked_lm_predictions, get_decay_power
from ...token import WordPieceTokenizer
from ...third import tf
from ... import com


class SQPLM(LMModule):
    """ Language modeling on Search-Query-Pretraining. """
    ...
    def _convert_X(self, X_target, is_training, tokenized):
        ...
        for idx, segments in enumerate(segment_input_tokens):
            ...
            for s_id, segment in enumerate(segments):
                ...
                _segment_ids.extend([0] * (len(segment) + 1))
