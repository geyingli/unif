...
from ..model.bert import BERTDecoder, BERTConfig, create_instances_from_document
from ..model.unilm import UniLMEncoder, create_masked_lm_predictions, get_decay_power
...
class UniLM(BERTLM, LMModule):
    ...
    def _get_fit_ops(self, as_feature=False):
        ...
        if self.mode == "bi":
            ops.extend([self._tensors["NSP_preds"], self._tensors["NSP_losses"]])
        if as_feature:
