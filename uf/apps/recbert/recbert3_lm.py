...
from .recbert3 import RecBERT3, sample_wrong_tokens, get_decay_power
...
class RecBERT3LM(LMModule):
    """ Language modeling on RecBERT-3. """
    ...
    def convert(self, X=None, y=None, sample_weight=None, X_tokenized=None, is_training=False, is_parallel=False):
        ...
        if X is not None or X_tokenized is not None:
            ...
            (input_tokens, input_ids,
             add_label_ids, rep_label_ids, cls_label_ids) = self._convert_X(X_target, tokenized=tokenized, is_training=is_training)
    ...
    def _convert_X(self, X_target, tokenized, is_training):
        ...
        for idx in range(len(tokenized_input_ids)):
            ...
            if is_training:
                ...
                max_del = np.sum(np.random.random(nonpad_seq_length) < self._rep_prob / 2)

                ok = sample_wrong_tokens(
                    _input_ids, _add_label_ids, _rep_label_ids,
        ...
        return input_tokens, input_ids, add_label_ids, rep_label_ids, cls_label_ids
    ...
    def _get_fit_info(self, output_arrays, feed_dict, from_tfrecords=False):
        ...
        if from_tfrecords:
            ...
            batch_rep_labels = output_arrays[-2]
